...
const adapters = [new AshbyAdapter(), new GreenhouseAdapter(), new RipplingAdapter(), new BreezyAdapter(), new LeverAdapter(), new WorkableAdapter(), new BambooHrAdapter(), new RecruiteeAdapter()];
...
export function detectAdapter(value) {
